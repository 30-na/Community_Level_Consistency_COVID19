...
fig_consis_NHCS_3week_line_LMH_MT_suppNA = ggplot(data = consis_3week_LMH_MT_suppNA,
                                               aes(x = date,
                                                   y = consisRate,
...
fig_consis_NHCS_3week_box_LMH_MT_suppNA = ggplot(data = consis_3week_LMH_MT_suppNA,
...
compare_consis_NHCS_3week_LMH_MT_suppNA = grid.arrange(fig_consis_NHCS_3week_line_LMH_MT_suppNA,
                                                    fig_consis_NHCS_3week_box_LMH_MT_suppNA,
                                                    nrow = 1,
                                                    ncol = 3,
                                                    layout_matrix = rbind(c(1,1,2)))

ggsave("Result/Figures/compare_consis_NHCS_3week_LMH_MT_suppNA.jpg",
       compare_consis_NHCS_3week_LMH_MT_suppNA, 
