...
fig_consis_NHCS_3week_line_LMH = ggplot(data = consis_3week_LMH,
                                   aes(x = date,
                                       y = consisRate,
...
fig_consis_NHCS_3week_box_LMH = ggplot(data = consis_3week_LMH,
...
compare_consis_NHCS_3week_LMH = grid.arrange(fig_consis_NHCS_3week_line_LMH,
                                            fig_consis_NHCS_3week_box_LMH,
                                            nrow = 1,
                                            ncol = 3,
                                            layout_matrix = rbind(c(1,1,2)))

ggsave("Result/Figures/compare_consis_NHCS_3week_LMH.jpg",
       compare_consis_NHCS_3week_LMH, 
