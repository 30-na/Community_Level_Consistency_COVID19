...
hospital_utilization = hospital_utilization_supp1 %>%
    mutate(fips_code = as.numeric(fips_code))
...
community_level_LMH_supp1 = community_level_county %>%
    drop_na(community_level)

save(community_level_LMH_supp1,
     file="Result/CDC_community_level_county_computed_low_medium_high_supp1.RDA")
...
#remove NA value
community_level_MH_supp1 = community_level_county %>%
    drop_na(community_level)

#save the file
save(community_level_MH_supp1,
     file="Result/CDC_community_level_county_computed_merged_high_medium_supp1.RDA")
...
community_level_LM_supp1 = community_level_county %>%
    drop_na(community_level)

save(community_level_LM_supp1,
     file="Result/CDC_community_level_county_computed_merged_low_medium_supp1.RDA")
