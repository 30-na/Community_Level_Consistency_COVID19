...
save(community_level_county_computed, file="Result/CDC_community_level_county_computed.RDA")
...
#save the file
save(community_level_county_computed, file="Result/CDC_community_level_county_computed_merged_Medium_With_High.RDA")
...
save(community_level_county_computed, file="Result/CDC_community_level_county_computed_merged_Medium_With_Low.RDA")
