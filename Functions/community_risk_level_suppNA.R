...
community_level_LMH_suppNA = community_level_county %>%
    drop_na(community_level)

save(community_level_LMH_suppNA,
     file="Result/CDC_community_level_county_computed_low_medium_high_suppNA.RDA")
...
#remove NA value
community_level_MH_suppNA = community_level_county %>%
    drop_na(community_level)

#save the file
save(community_level_MH_suppNA,
     file="Result/CDC_community_level_county_computed_merged_high_medium_suppNA.RDA")
...
community_level_LM_suppNA = community_level_county %>%
    drop_na(community_level)

save(community_level_LM_suppNA,
     file="Result/CDC_community_level_county_computed_merged_low_medium_suppNA.RDA")
