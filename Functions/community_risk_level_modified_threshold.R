...
community_level_LMH_MT = community_level_county %>%
    drop_na(community_level)

save(community_level_LMH_MT,
     file="Result/CDC_community_level_county_computed_low_medium_high_modified_threshold.RDA")
...
#remove NA value
community_level_MH_MT = community_level_county %>%
    drop_na(community_level)
...
community_level_ML_MT = community_level_county %>%
    drop_na(community_level)

save(community_level_ML_MT,
     file="Result/CDC_community_level_county_computed_merged_low_medium_modified_threshold.RDA")
