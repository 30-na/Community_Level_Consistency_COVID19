...
fig_consis_NHCS_3week_line_LMH_supp1 = ggplot(data = consis_3week_LMH_supp1,
                                               aes(x = date,
                                                   y = consisRate,
...
fig_consis_NHCS_3week_box_LMH_supp1 = ggplot(data = consis_3week_LMH_supp1,
...
compare_consis_NHCS_3week_LMH_supp1 = grid.arrange(fig_consis_NHCS_3week_line_LMH_supp1,
                                                    fig_consis_NHCS_3week_box_LMH_supp1,
                                                    nrow = 1,
                                                    ncol = 3,
                                                    layout_matrix = rbind(c(1,1,2)))

ggsave("Result/Figures/compare_consis_NHCS_3week_LMH_supp1.jpg",
       compare_consis_NHCS_3week_LMH_supp1, 
