...
fig_consis_NHCS_3week_line_LMH_supp3 = ggplot(data = consis_3week_LMH_supp3,
                                              aes(x = date,
                                                  y = consisRate,
...
fig_consis_NHCS_3week_box_LMH_supp3 = ggplot(data = consis_3week_LMH_supp3,
...
compare_consis_NHCS_3week_LMH_supp3 = grid.arrange(fig_consis_NHCS_3week_line_LMH_supp3,
                                                   fig_consis_NHCS_3week_box_LMH_supp3,
                                                   nrow = 1,
                                                   ncol = 3,
                                                   layout_matrix = rbind(c(1,1,2)))

ggsave("Result/Figures/compare_consis_NHCS_3week_LMH_supp3.jpg",
       compare_consis_NHCS_3week_LMH_supp3, 
