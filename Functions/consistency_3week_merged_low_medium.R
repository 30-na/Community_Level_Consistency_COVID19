...
fig_consis_3week_line_LM = ggplot(data = consis_3week_LM,
                                   aes(x = date,
                                       y = consisRate,
...
fig_consis_3week_box_LM = ggplot(data = consis_3week_LM,
...
fig_consis_3week_total_line_LM = ggplot(consis_3week_total_LM, aes(x=date,
                                                                y=consisRate))+
    geom_smooth(method = "lm",
                formula = y ~ poly(x, 21),
                color = "#fc8d62")+
...
fig_consis_3week_total_box_LM = ggplot(consis_3week_total_LM, aes(y=consis_3weeks, x=consisRate))+
...
save(consis_3week_LM,
     ...
     fig_consis_3week_line_LM,
     fig_consis_3week_box_LM,
     fig_consis_3week_total_line_LM,
     fig_consis_3week_total_box_LM,
     file = "Result/consistency_3week_merged_low_medium.Rda")
