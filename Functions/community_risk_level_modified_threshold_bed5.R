...
community_level_LMH_MT_b5 = community_level_county %>%
    drop_na(community_level)

save(community_level_LMH_MT_b5,
     file="Result/CDC_community_level_county_computed_low_medium_high_modified_threshold_b5.RDA")
...
#remove NA value
community_level_MH_MT_b5 = community_level_county %>%
    drop_na(community_level)

#save the file
save(community_level_MH_MT_b5,
     file="Result/CDC_community_level_county_computed_merged_high_medium_modified_threshold_b5.RDA")
...
community_level_ML_MT_b5 = community_level_county %>%
    drop_na(community_level)

save(community_level_ML_MT_b5,
     file="Result/CDC_community_level_county_computed_merged_low_medium_modified_threshold_b5.RDA")
