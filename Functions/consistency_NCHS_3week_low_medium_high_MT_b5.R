...
fig_consis_NHCS_3week_line_LMH_MT_b5 = ggplot(data = consis_3week_LMH_MT_b5,
                                              aes(x = date,
                                                  y = consisRate,
...
fig_consis_NHCS_3week_box_LMH_MT_b5 = ggplot(data = consis_3week_LMH_MT_b5,
...
compare_consis_NHCS_3week_LMH_MT_b5 = grid.arrange(fig_consis_NHCS_3week_line_LMH_MT_b5,
                                                   fig_consis_NHCS_3week_box_LMH_MT_b5,
                                                   nrow = 1,
                                                   ncol = 3,
                                                   layout_matrix = rbind(c(1,1,2)))

ggsave("Result/Figures/compare_consis_NHCS_3week_LMH_MT_b5.jpg",
       compare_consis_NHCS_3week_LMH_MT_b5, 
